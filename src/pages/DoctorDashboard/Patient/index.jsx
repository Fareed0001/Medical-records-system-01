...
const Index = () => {
    ...
    const handleDeleteClick = (medicalRecordNumber) => {
        // Remove the patient with the specified medical record number
        const updatedPatients = patients.filter(patient => patient.medicalRecordNumber !== medicalRecordNumber);
                        ...
                        <div className={`col-6 ${styles.searchDiv}`}>
                            <form className="d-flex" role="search">
                                <input
                                    ...
                                    type="search"
                                    placeholder="Search by name or primary care physician"
                                    aria-label="Search"
                                    value={searchInput}
                            ...
                            <div className={styles.contentTable}>
                                <div className={`container ${styles.contentTableHead}`}>
                                    <div className="row">
                                        ...
                                        <div className='d-none d-sm-block d-md-block d-lg-block col-sm-4 col-lg-2'>Medical Record Number</div>
                                ...
                                {patientPageData.map((patient, index) => (
                                    <div className={`container ${styles.contentTableBody}`} key={patient.medicalRecordNumber}>
                                        <div className="row">
                                            ...
                                            <div className='col-8 col-sm-5 col-lg-2'>{patient.name}</div>
