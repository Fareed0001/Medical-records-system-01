...
const Index = () => {
    ...
    // Function to filter patients with doctors only
    const patientsWithNurses = patients.filter(patient => patient.doctorsNote);
    ...
    const filteredPatients = patientsWithNurses.filter(patient =>
        ...
        patient.doctor.doctorsNote.date.toLowerCase().includes(searchInput.toLowerCase()) ||
        patient.doctor.doctorsNote.temperature.toLowerCase().includes(searchInput.toLowerCase())
    );
                        ...
                        <div className="tab-pane fade show active" id="menu0" role="tabpanel" aria-labelledby="menu0-tab">
                            <div className={styles.contentTable}>
                                ...
                                <div className={`container ${styles.contentTableBody}`} key={patient.id}>
                                    ...
                                    <div className='col-2 d-none d-lg-block'>{patient.doctorsNote.date}</div>
                                    <div className='col-2 d-none d-lg-block'>{patient.doctorsNote.summary}</div>
                                        ...
                                        <div className="modal fade" id={`staticBackdrop-${patient.medicalRecordNumber}`} data-bs-backdrop="static" data-bs-keyboard="false" tabIndex="-1" aria-labelledby={`staticBackdropLabel-${patient.medicalRecordNumber}`} aria-hidden="true">
                                            <div className="modal-dialog">
                                                ...
                                                <div className="modal-body">
                                                    <strong>Date: </strong>
                                                    {patient.doctorsNote.date}
                                                    <hr />
                                                    <strong>Patient temperature: </strong>
                                                    {patient.doctorsNote.temperature}
                                                    <hr />
                                                    <strong>Urine output: </strong>
                                                    {patient.doctorsNote.urineOutput}
                                                    <hr />
                                                    <strong>Nurses Notes: </strong>
                                                    {patient.doctorsNote.notes}
                                                    <hr />
                                                    <strong>Summary: </strong>
                                                    {patient.doctorsNote.summary}
                                                </div>
