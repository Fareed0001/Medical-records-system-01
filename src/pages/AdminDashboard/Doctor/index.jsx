                    ...
                    <div className={`row ${styles.searchNextDiv}`}>
                        <div className={`col-6 ${styles.searchDiv}`}>
                            <form class="d-flex" role="search">
                                ...
                                <button class="btn btn-primary" type="submit"><BiSearch /></button>
                            </form>
                        </div>
                            ...
                            <div className={styles.contentTable}>
                                ...
                                <div className={styles.contentTableBody}>
                                    <div className="row">
                                        ...
                                        <div className='col-2'>
                                            <button type="button" class="btn btn-primary"><FiEdit2 /> Edit</button>
                                            <button type="button" class="btn btn-danger">Delete <BsTrashFill /></button>
                                        </div>
                                    </div>
                                </div>
                                <div className={styles.contentTableBody}>
