...
import MobileSidebar from '@/components/Navbar/ReceptionistNavbar/ReceptionistMobileSidebar/MobileSidebar';
    ...
    return (
        <div className={`container ${styles.navbar}`}>
            ...
            <p className={styles.greeting}>
                <span className={styles.username}>RN Amaka</span> <br />
            ...
            <Link href="/" className={styles.roleLink}>
                <p className={styles.role}><span className={styles.icon}>
                    <FaHospitalUser /></span> Receptionist</p>
            </Link>
