...
import MobileSidebar from '@/components/Navbar/PharmacistNavbar/PharmacistMobileSidebar/MobileSidebar';
    ...
    return (
        <div className={`container ${styles.navbar}`}>
            ...
            <p className={styles.greeting}>
                <span className={styles.username}>PharmD Tony</span> <br />
