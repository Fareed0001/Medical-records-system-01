...
import MobileSidebar from '@/components/Navbar/CashierNavbar/CashierMobileSidebar/MobileSidebar';
    ...
    return (
        <div className={`container ${styles.navbar}`}>
            ...
            <p className={styles.greeting}>
                <span className={styles.username}>Isa Halima</span> <br />
            ...
            <Link href="/" className={styles.roleLink}>
                ...
                <PiUserCircleGearFill /></span> Cashier</p>
            </Link>
