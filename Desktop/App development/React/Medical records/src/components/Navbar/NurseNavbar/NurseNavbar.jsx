...
import MobileSidebar from '@/components/Navbar/NurseNavbar/NurseMobileSidebar/MobileSidebar';
    ...
    return (
        <div className={`container ${styles.navbar}`}>
            ...
            <p className={styles.greeting}>
                <span className={styles.username}>RN Angela</span> <br />
            ...
            <Link href="/" className={styles.roleLink}>
                <p className={styles.role}><span className={styles.icon}>
                    <LiaUserNurseSolid /></span> Nurse</p>
            </Link>
