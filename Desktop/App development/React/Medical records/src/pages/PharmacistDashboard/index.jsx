...
const Index = () => {
    ...
    const filteredPatients = patients
        .filter(patient => patient.prescription && patient.prescription.drug) // Only include patients with the "prescription" object
        .filter(patient =>
                ...
                <div className={styles.content}>
                    <ul className="nav nav-tabs" id="myTabs">
                        <li className="nav-item">
                            <a className={`nav-link active ${styles.navLink}`} id="menu0-tab" data-bs-toggle="tab" href="#menu0" role="tab" aria-controls="menu0" aria-selected="true">Previous prescription</a>
                        </li>
                    </ul>
                            ...
                            <div className={styles.contentTable}>
                                <div className={`container ${styles.contentTableHead}`}>
                                    <div className="row">
                                        ...
                                        <div className='col-4 d-none d-lg-block'>Medication</div>
                                ...
                                {patientPageData.map((patient, index) => (
                                    <div className={`container ${styles.contentTableBody}`} key={patient.medicalRecordNumber}>
                                        <div className="row">
                                            ...
                                            <div className='col-4 d-none d-lg-block'>{patient.prescription.drug}</div>
                                                    ...
                                                    <div className="modal-dialog modal-dialog-centered modal-dialog-scrollable">
                                                        <div className="modal-content">
                                                            ...
                                                            <div className="modal-body">
                                                                <div className="mb-3">
                                                                    <p><strong>Medication:</strong> {patient.prescription.drug}</p>
                                                                </div>
                                                                <hr />
                                                                <div className="mb-3">
                                                                   <strong>Dispensing Instructions:</strong>  {patient.prescription.dispensingInstructions}</div>
                                                            </div>
